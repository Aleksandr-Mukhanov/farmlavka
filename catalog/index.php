...
// фильтрация бренда
global $arrFilter;
if ($_REQUEST['brand']) $arrFilter['PROPERTY_BRAND'] = $_REQUEST['brand'];

if ($_REQUEST['tag'] == 'action') $arrFilter['PROPERTY_ACTION'] = 11;
elseif ($_REQUEST['tag'] == 'sale') $arrFilter['PROPERTY_ACTION'] = 11;
elseif ($_REQUEST['tag']) $arrFilter['PROPERTY_TAGS'] = $_REQUEST['tag'];

if ($_REQUEST['diseases']) $arrFilter['PROPERTY_DISEASES'] = $_REQUEST['diseases'];
?>
