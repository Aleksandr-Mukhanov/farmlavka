...
<div class="swiper-slide main-content__left-block">
 ...
 <span class="block__title__span">Oral-b vitality <br>
 </span>электрическая зубная щетка
		</p>
		<p class="left-block__text fz-16px">
			 Клинически доказано, что электрическая зубная щетка более эффективно очищает полость рта по сравнению с обычной мануальной зубной щеткой.
		</p>
	...
	<div class="left-block__img-block">
		<div>
 <img width="324px" alt="электронная зубная щетка" src="/local/templates/farmlavka/img/main-content/left-block.jpg" height="324px" class="img img-p left-block__img"><br>
		</div>
	</div>
 ...
 <a href="/catalog/" class="button main-content_button shadow_blue">
		...
		<div class="svg main-content_button__svg">
		</div>
 </a>
	</div>
</div>
...
<div class="swiper-slide main-content__right-block">
	<div class="right-block__first-block">
		<div class="right-block__first-block__body">
			<p class="first-block__body__title fz-18px">
				 Увлажняющий крем для лица <span class="block__title__span right-block__body__span"><br>
				 Nivea Care</span>
			</p>
			<div class="right-block__body__img-block">
 <img width="270px" alt="Увлажняющий крем для лица Nivea Care" src="/local/templates/farmlavka/img/main-content/right-block.jpg" height="250px" class="img right-block__body__img">
			</div>
 ...
 <a href="/catalog/" class="button main-content_button main-content_button_2">
    ...
    ?> <?foreach ($arHit as $product) {?> <a href="<?=$product['DETAIL_PAGE_URL']?>" class="second-block__item">
		<div class="second-block__item__body">
			<div class="second-block__item__block-img">
 <img width="80px" src="<?=CFile::GetPath($product['PREVIEW_PICTURE'])?>" height="80px">
			</div>
			<div class="second-block__item__info">
				...
				<div class="second-block__item__price-block">
                  ...
                  $showStar = ($i < round($product['PROPERTY_RATING_VALUE'])) ? 'star' : 'star-minus'; ?>
						<div class="svg star-small <span id=" title="Код PHP: &lt;?=$showStar?&gt;">
							 <?=$showStar?><span class="bxhtmled-surrogate-inner"><span class="bxhtmled-right-side-item-icon"></span><span class="bxhtmled-comp-lable" unselectable="on" spellcheck="false">Код PHP</span></span>"&gt;
						</div>
						 <?}?>
					</div>
				</div>
