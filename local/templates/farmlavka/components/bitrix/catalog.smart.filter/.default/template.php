...
?>
<div class="bx-filter categories__filter-block none-960">
	<div class="bx-filter-section container-fluid">
		<div class="line__top-bottom section__block-title">
			<p class="section__title"><?echo GetMessage("CT_BCSF_FILTER_TITLE")?></p>
		</div>
								...
								<div class="row bx-filter-parameters-box-container">
									<div class="col-xs-6 bx-filter-parameters-box-container-block bx-left">
										<div class="bx-filter-input-container">
											<input
												class="min-price range-slider-input-start"
												type="text"
									...
									<div class="col-xs-6 bx-filter-parameters-box-container-block bx-right">
										<div class="bx-filter-input-container">
											<input
												class="max-price range-slider-input-end"
												type="text"
									...
									<div class="col-xs-12 range-slider__in_filter">
			...
			<div class="row">
				<div class="col-xs-12 bx-filter-button-box">
					<div class="bx-filter-block">
						<div class="bx-filter-parameters-box-container block_button">
							<input
