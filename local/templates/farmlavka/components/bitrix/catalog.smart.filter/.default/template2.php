...
?>
<div class="categories__filter-block none-960">
		<div class="line__top-bottom section__block-title">
			<p class="section__title">Фильтр</p>
		</div>
			...
			<div class="row">
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						$valueMin = ($arItem["VALUES"]["MIN"]["HTML_VALUE"]) ? $arItem["VALUES"]["MIN"]["HTML_VALUE"] : $arItem["VALUES"]["MIN"]["VALUE"];
						$valueMax = ($arItem["VALUES"]["MAX"]["HTML_VALUE"]) ? $arItem["VALUES"]["MAX"]["HTML_VALUE"] : $arItem["VALUES"]["MAX"]["VALUE"];
						// dump($arItem["VALUES"]["MIN"]);
						?>
						<div class="line__top-bottom filter__block MBShow">
							<span class="bx-filter-container-modef"></span>
							<div class="filter__title SBtn"><?=$arItem["NAME"]?>
								<div class="svg filter__item-svg"></div>
							</div>
							<div class="filter__values BShow">
								<div class="range-slider__prices">
									<div class="range-slider__price__start">
										<input
											class="range-slider-input-start"
								...
								<section class="range-slider">
									<input class="rangeValues__input-1" value="<?=$valueMin?>" min="<?=$arItem["VALUES"]["MIN"]["VALUE"]?>" max="<?=$arItem["VALUES"]["MAX"]["VALUE"]?>" step="1" type="range" onchange="smartFilter.keyup(this)">
									<input class="rangeValues__input-2" value="<?=$valueMax?>" min="<?=$arItem["VALUES"]["MIN"]["VALUE"]?>" max="<?=$arItem["VALUES"]["MAX"]["VALUE"]?>" step="1" type="range" onchange="smartFilter.keyup(this)">
								</section>
							</div>
						</div>
						<?
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					?>
					<div class="line__top-bottom categories__country MBShow">
						<span class="bx-filter-container-modef"></span>
						<div class="filter__title SBtn">
							<?=$arItem["NAME"]?>
							<div class="svg filter__item-svg"></div>
						</div>

						<ul class="country__items BShow" data-role="bx_filter_block">
							<?
									...
									<?foreach($arItem["VALUES"] as $val => $ar):?>
										<li class="filter-option filter-checkbox">
											<input
												...
												onclick="smartFilter.click(this)"
											/>
											<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="filter__checkbox-label <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
												<span title="<?=$ar["VALUE"];?>">
													<?=$ar["VALUE"];?>
													<?if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
