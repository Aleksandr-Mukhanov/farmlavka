...
if ($USER->IsAdmin()) {
// echo "<pre>";
// print_r($arResult['PROPERTIES']['OTHER_ARTICLES']);
// echo "<pre>";
}
...
<main class="main categories-main">
	...
	<div class="_container articles_container">
			...
			<div class="articles__a-content-main">
				<div class="a-content-main__left">
					<div class="a-content-main__left__body MBShow">
						<div class="c-main__title user ">
							...
							<?
							$arTitles = [
								$arResult['PROPERTIES']['TITLE_H2']['VALUE'],
								$arResult['PROPERTIES']['TITLE_H3']['VALUE'],
								$arResult['PROPERTIES']['TITLE_H4']['VALUE'],
								$arResult['PROPERTIES']['TITLE_H5']['VALUE'],
						...
						<ul class="c-main__items BShow">
							...
							foreach ($arTitles as $title) {?>
								<li class="c-main__li">
									<a href="#part<?=$i?>" class="c-main__item">
										<p class="c-main__item__text"><?=$title?>;
										</p>
									</a>
								</li>
							<? $i++;
				...
				<div class="a-content-main__right">
					<div class="a-content-main__right__body">
						...
						<p class="articles__text"><?=$arResult['DETAIL_TEXT']?></p>
		...
		<div class="acticle__a-info-block">
			<h2 id="part1" class="article-suptitle article-suptitle-h2"><?=$arResult['PROPERTIES']['TITLE_H2']['VALUE']?></h2>
		...
		<div class="acticle__a-info-block">
			<h3 id="part2" class="article-suptitle article-suptitle-h3"><?=$arResult['PROPERTIES']['TITLE_H3']['VALUE']?></h3>
			<p class="articles__text"><?=$arResult['PROPERTIES']['TEXT_H3']['VALUE']['TEXT']?></p>
		</div>
		<div class="acticle__a-info-block">
			<h2 id="part3" class="article-suptitle article-suptitle-h4"><?=$arResult['PROPERTIES']['TITLE_H4']['VALUE']?></h2>
			<p class="articles__text"><?=$arResult['PROPERTIES']['TEXT_H4']['VALUE']['TEXT']?></p>
		</div>
		<h2 id="part4" class="article-suptitle article-suptitle-h5"><?=$arResult['PROPERTIES']['TITLE_H5']['VALUE']?></h2>
		...
		<div class="acticle__a-video">
			<h6 id="part5" class="article-suptitle article-suptitle-h6">
				<?=$arResult['PROPERTIES']['TITLE_H6']['VALUE']?>
			</h6>
